...
```json
{
  "impact_score": 88,
  "impact_label": "high",
  "rationale": "Frontier model release from top-tier lab with significant capability improvements across coding, reasoning, and multimodal tasks"
}
```
...
`rationale` must be one concise sentence (max 20 words).
